...
>
  <x-slot:content>
    ...
    >
      ...
      {{-- header start --}}
      <div class="mb-10">
        <h1 class="font-serif text-4xl font-semibold text-stone-900">
          Pertanyaan Yang Sering Ditanyakan
        </h1>
        <p class="mt-3 w-3/4 text-stone-500">
      ...
      <div class="border-t border-stone-200">
        ...
        >
          ...
          >
            <button
              type="button"
              class="group flex w-full items-center justify-between gap-4 px-2 py-4 text-left transition-colors duration-300 hover:bg-stone-100"
              x-on:click="toggle(i)"
