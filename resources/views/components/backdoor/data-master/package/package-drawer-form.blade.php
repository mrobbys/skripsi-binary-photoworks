    ...
    <div class="overflow-hidden absolute inset-0">
      <div class="flex fixed inset-y-0 right-0 pl-10 max-w-full">
        ...
        <div
          ...
          <form x-on:submit.prevent="submitPackage" class="flex overflow-y-auto flex-col h-full bg-stone-50 border-l shadow-2xl border-stone-200">
                      ...
                      <template x-for="(feature, index) in state.form.features" :key="index">
                        <div class="flex items-center gap-2">
                          ...
                          <input
                            ...
                            class="block w-full rounded-md border-neutral-300 shadow-sm focus:border-stone-500 focus:ring-stone-500 sm:text-sm p-3"
