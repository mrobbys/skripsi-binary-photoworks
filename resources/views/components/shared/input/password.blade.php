...
>
  <input
    ...
    {{ $attributes->merge(['class' => 'w-full border-b p-2 text-sm text-stone-900 transition-colors placeholder:text-stone-400 focus:outline-none bg-transparent pr-10 ring-0']) }}
  >
