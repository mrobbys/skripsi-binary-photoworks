...
@php
    ...
    try {
        ...
        // Session mungkin tidak tersedia — fallback ke beranda
    }
@endphp
...
<body class="h-full bg-stone-50 font-sans text-stone-900 antialiased selection:bg-stone-700 selection:text-stone-100 flex items-center justify-center p-4 sm:p-6 lg:p-8">
  <main id="main-content" class="w-full max-w-md sm:max-w-lg border border-stone-300 bg-stone-100 p-6 sm:p-10 md:p-12 text-center">
    ...
    <div class="mt-8 flex justify-center">
      <a href="{{ $targetUrl }}"
         class="inline-flex min-h-[44px] min-w-[44px] items-center justify-center border border-stone-700 bg-stone-700 px-6 py-3 text-xs sm:text-sm font-semibold text-stone-50 transition-colors duration-150 hover:bg-stone-800 focus:outline-none focus-visible:ring-2 focus-visible:ring-stone-700 focus-visible:ring-offset-2 focus-visible:ring-offset-stone-100 active:bg-stone-900">
        {{ $buttonLabel }}
      </a>
    </div>
  </main>
