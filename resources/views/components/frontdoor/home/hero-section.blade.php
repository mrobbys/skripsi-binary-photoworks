<section class="w-full">
  <div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
    ...
    <div class="flex flex-col items-start space-y-6">
      <h1 data-animate="hero-left-item" class="font-serif text-4xl font-normal leading-tight tracking-tight text-stone-900 sm:text-5xl lg:text-6xl">
        Abadikan Momen Berharga Anda
      </h1>

      <p data-animate="hero-left-item" class="max-w-lg text-sm sm:text-base lg:text-lg leading-relaxed text-stone-600">
        Studio fotografi profesional untuk mengabadikan setiap detail cerita Anda.
      </p>

      <div data-animate="hero-left-item" class="pt-2">
        <x-shared.button
          as="a"
    ...
    {{-- right start --}}
    <div data-animate="hero-right" class="relative h-100 w-full overflow-hidden sm:h-125 lg:h-150">
      <img
